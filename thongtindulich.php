...
$baiviet_list = $baiviet->show_bv_limit(8, 0); // Sử dụng hàm show_bv_limit với limit = 4 và offset = 0
...
<div style="margin-top: 100px;" class="info_tinh">
    ...
    <form action="filter.php" method="post" class="loc_bv" >
        ...
        <button style="margin-bottom:10px ;" class="locbv" type="submit">Lọc</button>
    </form>
